...
for gen in gens:
    ...
    for flav in flavs:
        ...
        for campaign in campaigns:
            fn = pathbase+flav+'_'+gen+'.mc16'+campaign+'.root'
            f = TFile(fn,'read')
...
for gen in gens:
    ...
    for flav in flavs:
        ...
        print 'ratio to nominal:',evnts[gen][flav]/evnts[nominal_gen][flav],'\tfraction of total:',evnts[gen][flav]/evnts[gen]['total'],'\tratio to nominal of fraction:',(evnts[gen][flav]/evnts[gen]['total'])/(evnts[nominal_gen][flav]/evnts[nominal_gen]['total'])
    print ""