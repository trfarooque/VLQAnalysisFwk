...
int main(int argc, char** argv){
  ...
  fChain->SetBranchAddress("o_hthad", &o_hthad, &b_o_hthad);
...
*/
  ...
  variables.push_back("rcjet1_m_sumj");
  variables.push_back("rcjet1_m_sumj_trim05");
  variables.push_back("rcjet1_m_sumj_trim10");
  variables.push_back("rcjet1_m_sumj_trim20");
  variables.push_back("rcjet1_mjsum");
  variables.push_back("rcjet1_mjsum_trim05");
  variables.push_back("rcjet1_mjsum_trim10");
  variables.push_back("rcjet1_mjsum_trim20");
  variables.push_back("rcjet1_nconsts");
  variables.push_back("rcjet1_njets");
  variables.push_back("rcjet1_njets_trim05");
  variables.push_back("rcjet1_njets_trim10");
  variables.push_back("rcjet1_njets_trim20");
  variables.push_back("rcjet1_nbjets");
  ...
  variables.push_back("rcjet1_sj1_dR");
  variables.push_back("rcjet1_sj2_dR");
  variables.push_back("rcjet1_sjge3_dR");
  variables.push_back("rcjet1_sj1_dRmin_j");
  variables.push_back("rcjet1_sj2_dRmin_j");
  variables.push_back("rcjet1_sjge3_dRmin_j");

  variables.push_back("rcjet2_pt");
  variables.push_back("rcjet2_eta");
  variables.push_back("rcjet2_phi");
  variables.push_back("rcjet2_mass");
  variables.push_back("rcjet2_m_sumj");
  variables.push_back("rcjet2_m_sumj_trim05");
  variables.push_back("rcjet2_m_sumj_trim10");
  variables.push_back("rcjet2_m_sumj_trim20");
  variables.push_back("rcjet2_mjsum");
  variables.push_back("rcjet2_mjsum_trim05");
  variables.push_back("rcjet2_mjsum_trim10");
  variables.push_back("rcjet2_mjsum_trim20");
  variables.push_back("rcjet2_nconsts");
  variables.push_back("rcjet2_njets");
  variables.push_back("rcjet2_njets_trim05");
  variables.push_back("rcjet2_njets_trim10");
  variables.push_back("rcjet2_njets_trim20");
  variables.push_back("rcjet2_nbjets");
  ...
  variables.push_back("rcjet2_sj1_dR");
  variables.push_back("rcjet2_sj2_dR");
  variables.push_back("rcjet2_sjge3_dR");
  variables.push_back("rcjet2_sj1_dRmin_j");
  variables.push_back("rcjet2_sj2_dRmin_j");
  variables.push_back("rcjet2_sjge3_dRmin_j");

  variables.push_back("rcjets_pt");
  variables.push_back("rcjets_eta");
  variables.push_back("rcjets_phi");
  variables.push_back("rcjets_mass");
  variables.push_back("rcjets_m_sumj");
  variables.push_back("rcjets_m_sumj_trim05");
  variables.push_back("rcjets_m_sumj_trim10");
  variables.push_back("rcjets_m_sumj_trim20");
  variables.push_back("rcjets_mjsum");
  variables.push_back("rcjets_mjsum_trim05");
  variables.push_back("rcjets_mjsum_trim10");
  variables.push_back("rcjets_mjsum_trim20");
  variables.push_back("rcjets_nconsts");
  variables.push_back("rcjets_njets");
  variables.push_back("rcjets_njets_trim05");
  variables.push_back("rcjets_njets_trim10");
  variables.push_back("rcjets_njets_trim20");
  variables.push_back("rcjets_nbjets");
  ...
  variables.push_back("rcjets_sj1_dR");
  variables.push_back("rcjets_sj2_dR");
  variables.push_back("rcjets_sjge3_dR");
  variables.push_back("rcjets_sj1_dRmin_j");
  variables.push_back("rcjets_sj2_dRmin_j");
  variables.push_back("rcjets_sjge3_dRmin_j");
  ...
  variables.push_back("jets_rc1_eta");
  variables.push_back("jets_rc1_phi");
  variables.push_back("jets_rc1_btagw");
  variables.push_back("jets_rc1_jvt");
  variables.push_back("jets_rc1_dR");
  variables.push_back("jets_rc1_dRmin_j");
  
  variables.push_back("bjets_rc1_pt");
  variables.push_back("bjets_rc1_mass");
  variables.push_back("bjets_rc1_eta");
  variables.push_back("bjets_rc1_phi");
  variables.push_back("bjets_rc1_btagw");
  variables.push_back("bjets_rc1_jvt");
  ...
  variables.push_back("jets_rc1_trim05_mass");
  variables.push_back("jets_rc1_trim05_eta");
  variables.push_back("jets_rc1_trim05_phi");
  variables.push_back("jets_rc1_trim05_btagw");
  variables.push_back("jets_rc1_trim05_jvt");
  variables.push_back("jets_rc1_trim05_dR");
  variables.push_back("jets_rc1_trim05_dRmin_j");
  
  variables.push_back("bjets_rc1_trim05_pt");
  variables.push_back("bjets_rc1_trim05_mass");
  variables.push_back("bjets_rc1_trim05_eta");
  variables.push_back("bjets_rc1_trim05_phi");
  variables.push_back("bjets_rc1_trim05_btagw");
  variables.push_back("bjets_rc1_trim05_jvt");
  ...
  variables.push_back("jets_rc1_trim10_eta");
  variables.push_back("jets_rc1_trim10_phi");
  variables.push_back("jets_rc1_trim10_btagw");
  variables.push_back("jets_rc1_trim10_jvt");
  variables.push_back("jets_rc1_trim10_dR");
  variables.push_back("jets_rc1_trim10_dRmin_j");
  
  variables.push_back("bjets_rc1_trim10_pt");
  variables.push_back("bjets_rc1_trim10_mass");
  variables.push_back("bjets_rc1_trim10_eta");
  variables.push_back("bjets_rc1_trim10_phi");
  variables.push_back("bjets_rc1_trim10_btagw");
  variables.push_back("bjets_rc1_trim10_jvt");
  ...
  variables.push_back("jets_rc1_trim20_eta");
  variables.push_back("jets_rc1_trim20_phi");
  variables.push_back("jets_rc1_trim20_btagw");
  variables.push_back("jets_rc1_trim20_jvt");
  variables.push_back("jets_rc1_trim20_dR");
  variables.push_back("jets_rc1_trim20_dRmin_j");
  
  variables.push_back("bjets_rc1_trim20_pt");
  variables.push_back("bjets_rc1_trim20_mass");
  variables.push_back("bjets_rc1_trim20_eta");
  variables.push_back("bjets_rc1_trim20_phi");
  variables.push_back("bjets_rc1_trim20_btagw");
  variables.push_back("bjets_rc1_trim20_jvt");
  ...
  for(long int entry = 0; entry < fChain->GetEntries(); ++entry){
	...
	double mjsum_trim10 = 0.; double m_sumj_trim10 = 0.;
	...
	std::vector<double> drj_rc;
	std::vector<double> drjjmin;
	std::vector<TLorentzVector> tlv_rc_sj;

	TLorentzVector tlv_rc_sumj_trim05;
	TLorentzVector tlv_rc_sumj_trim10;
	TLorentzVector tlv_rc_sumj_trim20;

	for( int ij = 0; ij < jets_n; ij++){
	  TLorentzVector tlv_j;
	  tlv_j.SetPtEtaPhiM(jets_pt->at(ij), jets_eta->at(ij), jets_phi->at(ij), jets_m->at(ij));
	  double dr_rj = tlv_rc.DeltaR(tlv_j);
	  if(dr_rj < 1.0){
	    nj_rc++;
	    tlv_rc_sumj += tlv_j;

	    tlv_rc_sj.push_back(tlv_j);
	    inds_rc_sj.push_back(ij);
	    drj_rc.push_back(dr_rj);
	    ...
	    if(irc == 0){
	      ...
	      */
	      ...
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_phi", jets_phi->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_btagw", jets_btagw->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_jvt", jets_jvt->at(ij), nomWeight);
		...
		*/
		...
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_phi", jets_phi->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_btagw", jets_btagw->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_jvt", jets_jvt->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_dR", dr_rj, nomWeight);
	...
	//-----------------------------------------------------------------
	//TRIMMING
	for(unsigned int i=0; i<inds_rc_sj.size(); i++){
	  int ij = inds_rc_sj.at(i);
	  TLorentzVector tlv_j =  tlv_rc_sj.at(i);
	  double dr_rj = drj_rc.at(i);
	  double dRmin_jj = drjjmin.at(i);

	  if(i == 0){
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj1_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj1_dR", dr_rj, nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj1_dRmin_j", dRmin_jj, nomWeight);
	    if(irc == 0){
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj1_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj1_dR", dr_rj, nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj1_dRmin_j", dRmin_jj, nomWeight);
	    }
	  }
	  else if(i == 1){
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj2_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj2_dR", dr_rj, nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sj2_dRmin_j", dRmin_jj, nomWeight);
	    if(irc == 0){
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj2_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj2_dR", dr_rj, nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sj2_dRmin_j", dRmin_jj, nomWeight);
	    }
	  }
	  else{
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sjge3_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sjge3_dR", dr_rj, nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"rcjets_sjge3_dRmin_j", dRmin_jj, nomWeight);
	    if(irc == 0){
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sjge3_ptfrac", jets_pt->at(ij)/tlv_rc_sumj.Pt(), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sjge3_dR", dr_rj, nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"rcjet1_sjge3_dRmin_j", dRmin_jj, nomWeight);
	    }
	  } 

	  if(tlv_j.Pt() >= tlv_rc_sumj.Pt()*0.05){
	    tlv_rc_sumj_trim05 += tlv_j;
	    nj_rc_trim05++;
	    mjsum_trim05 += jets_m->at(ij);

	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_pt", jets_pt->at(ij), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_mass", jets_m->at(ij), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_eta", jets_eta->at(ij), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_phi", jets_phi->at(ij), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_btagw", jets_btagw->at(ij), nomWeight);
	    m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim05_jvt", jets_jvt->at(ij), nomWeight);
	    ...
	    if(jets_btagw->at(ij) > 0.645925){
	      ...
	      m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim05_eta", jets_eta->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim05_phi", jets_phi->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim05_btagw", jets_btagw->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim05_jvt", jets_jvt->at(ij), nomWeight);
	    ...
	    if(tlv_j.Pt() >= tlv_rc_sumj.Pt()*0.10){
	      ...
	      nj_rc_trim10++;
	      mjsum_trim10 += jets_m->at(ij);

	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_pt", jets_pt->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_mass", jets_m->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_eta", jets_eta->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_phi", jets_phi->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_btagw", jets_btagw->at(ij), nomWeight);
	      m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim10_jvt", jets_jvt->at(ij), nomWeight);
		...
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim10_eta", jets_eta->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim10_phi", jets_phi->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim10_btagw", jets_btagw->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim10_jvt", jets_jvt->at(ij), nomWeight);
		...
		nj_rc_trim20++;
		mjsum_trim20 += jets_m->at(ij);

		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_pt", jets_pt->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_mass", jets_m->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_eta", jets_eta->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_phi", jets_phi->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_btagw", jets_btagw->at(ij), nomWeight);
		m_hstMngr->FillTH1D(region+"_"+"jets_rc1_trim20_jvt", jets_jvt->at(ij), nomWeight);
		...
		if(jets_btagw->at(ij) > 0.645925){
		  ...
		  m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim20_eta", jets_eta->at(ij), nomWeight);
		  m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim20_phi", jets_phi->at(ij), nomWeight);
		  m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim20_btagw", jets_btagw->at(ij), nomWeight);
		  m_hstMngr->FillTH1D(region+"_"+"bjets_rc1_trim20_jvt", jets_jvt->at(ij), nomWeight);
	...
	m_sumj = tlv_rc_sumj.M();
	m_sumj_trim05 = tlv_rc_sumj_trim05.M();
	m_sumj_trim10 = tlv_rc_sumj_trim10.M();
	...
	if(irc == 0){
	  ...
	  */
	  ...
	  m_hstMngr->FillTH1D(region+"_"+"rcjet1_mjsum_trim10", mjsum_trim10, nomWeight);
	  m_hstMngr->FillTH1D(region+"_"+"rcjet1_mjsum_trim20", mjsum_trim20, nomWeight);
	  
	  m_hstMngr->FillTH1D(region+"_"+"rcjet1_m_sumj", m_sumj, nomWeight);
	  m_hstMngr->FillTH1D(region+"_"+"rcjet1_m_sumj_trim05", m_sumj_trim05, nomWeight);
	  m_hstMngr->FillTH1D(region+"_"+"rcjet1_m_sumj_trim10", m_sumj_trim10, nomWeight);
	...
	*/
	...
	m_hstMngr->FillTH1D(region+"_"+"rcjets_mjsum_trim10", mjsum_trim10, nomWeight);
	m_hstMngr->FillTH1D(region+"_"+"rcjets_mjsum_trim20", mjsum_trim20, nomWeight);
	
	m_hstMngr->FillTH1D(region+"_"+"rcjets_m_sumj", m_sumj, nomWeight);
	m_hstMngr->FillTH1D(region+"_"+"rcjets_m_sumj_trim05", m_sumj_trim05, nomWeight);
	m_hstMngr->FillTH1D(region+"_"+"rcjets_m_sumj_trim10", m_sumj_trim10, nomWeight);
	m_hstMngr->FillTH1D(region+"_"+"rcjets_m_sumj_trim20", m_sumj_trim20, nomWeight);
