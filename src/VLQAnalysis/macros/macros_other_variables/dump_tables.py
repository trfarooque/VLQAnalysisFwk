...
meff            = {'name':"meff",'legend':"m_{eff} [GeV]"}
list_variables = [meff]
##______________________________________________________________________________
##
def writeScriptsAndLaunchJobs( scriptTempName, configFile, LaunchJobs = True ):
    pathToCreate = ""
...
temp_config = template_config.replace("_VAR_","meff")
...
writeScriptsAndLaunchJobs( outputDir+"/script_"+temp_config, outputDir+"/"+temp_config, LaunchJobs = True )
##..............................................................................
##
