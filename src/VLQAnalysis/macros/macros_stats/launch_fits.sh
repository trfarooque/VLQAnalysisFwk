...
dirBase=/nfs/at3/scratch2/tvdaalen/TRExFitter_WorkArea/Note/FullFit/
...
# inDirs=(" Asimov_BONLY_HF+PMGcor_prefit_templates_Jun24 ")
inDirs=(" Asimov_BONLY_HF+PMGcor_Jun18 ")
