  ...
  if(m_opt->DumpHistos()){
	...
	for ( int iTT =-1; iTT <=1; ++iTT ) {
	  ...
	  if(DrawReco){
	    ...
	    m_outMngrHist -> AddStandardTH1( decayType + "_recoVLQ" + str_id + "_eta1", 0.1, 0, 6, ";"+decayType+" reco VLQ"+str_id+" #eta(1)"    ,
					     DrawSyst, &(m_outData -> o_recoVLQ.at(decayType)), iTT, "eta1" );
	    m_outMngrHist -> AddStandardTH1( decayType + "_recoVLQ" + str_id + "_eta2", 0.1, 0, 6, ";"+decayType+" reco VLQ"+str_id+" #eta(2)"    ,
					     DrawSyst, &(m_outData -> o_recoVLQ.at(decayType)), iTT, "eta2" );
	...
	for ( int iTT =-1; iTT <=1; ++iTT ) {
	  ...
	  if(type.find("VLQ") != std::string::npos){
	    ...
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_fpT12",  0.1,0,5,  "; truth"+type+", "+str_id+" fpT_{12}"
					     , false, &(m_outData -> o_truth_partons.at(type)), iTT, "fpT12"/*, hopt_nouflow*/  );

	    //------------------------Casey Truth Studies Begin-----------------------------//
	    //------------------------Eta-----------------------------//
	    ...
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR14",  0.1,0,6,  "; truth"+type+", "+str_id+" #DeltaR_{14}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dR14"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR23",  0.1,0,6,  "; truth"+type+", "+str_id+" #DeltaR_{23}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dR23"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR24",  0.1,0,6,  "; truth"+type+", "+str_id+" #DeltaR_{24}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dR24"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR34",  0.1,0,6,  "; truth"+type+", "+str_id+" #DeltaR_{34}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dR34"/*, hopt_nouflow*/  );

	    //------------------------dR12-dR13-----------------------------//
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR12diffdR13",  0.1,-3,3,  "; truth"+type+", "+str_id+" #DeltaR_{12}-#DeltaR_{13}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dR12diffdR13"/*, hopt_nouflow*/  );

	    //------------------------dPhi-----------------------------//
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi12",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{12}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi12"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi13",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{13}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi13"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi14",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{14}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi14"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi23",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{23}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi23"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi24",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{24}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi24"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi34",  0.1,-1*TMath::Pi(), TMath::Pi(),  "; truth"+type+", "+str_id+" #Delta#phi_{34}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi34"/*, hopt_nouflow*/  );
            
	    //------------------------Eta-----------------------------//
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_eta1",  0.1,-5,5,  "; truth"+type+", "+str_id+" #eta_{1}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "eta1"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_eta2",  0.1,-5,5,  "; truth"+type+", "+str_id+" #eta_{2}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "eta2"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_eta3",  0.1,-5,5,  "; truth"+type+", "+str_id+" #eta_{3}"
                                             , true, &(m_outData -> o_truth_partons.at(type)), iTT, "eta3"/*, hopt_nouflow*/  );
	    m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_eta4",  0.1,-5,5,  "; truth"+type+", "+str_id+" #eta_{4}"
	    ...
	    // 2D histograms 
            ...
            m_outMngrHist -> AddStandardTH2( "dR12", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{12}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dR13", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{13}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dR14", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{14}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dR23", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{23}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dR24", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{24}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dR34", "truth_" + type + str_id + "_jetPt", 
                .1, 0, 6, 100, 0, 2500, ";Jet p_{T}", ";#DeltaR_{34}", 
	    ...
	    //------------------------ dPhi vs pT-----------------------------//
            m_outMngrHist -> AddStandardTH2( "dPhi12", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{12}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dPhi13", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{13}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dPhi14", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{14}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dPhi23", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{23}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dPhi24", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{24}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dPhi34", "truth_" + type + str_id + "_jetPt", 
                .1, -1*TMath::Pi(), TMath::Pi(), 100, 0, 2500, ";Jet p_{T}", ";#Delta#phi_{34}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta12", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{12}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta13", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{13}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta14", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{14}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta23", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{23}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta24", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{24}", 
            ...
            m_outMngrHist -> AddStandardTH2( "dEta34", "truth_" + type + str_id + "_jetPt", 
                .1, -5, 5, 100, 0, 2500, ";Jet p_{T}", ";#Delta#eta_{34}", 
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "dEta34", "jetPt");

	    //------------------------dEta12&34 vs ptRatio12&34-----------------------------// skipto
            m_outMngrHist -> AddStandardTH2( "dEta12", "truth_" + type + str_id + "_pTRatio12", 
                .5, -5, 5, .1, 0, 1, ";p_{T} Ratio_{12}", ";#Delta#eta_{12}", 
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "dEta12", "pTRatio12");
            m_outMngrHist -> AddStandardTH2( "dEta34", "truth_" + type + str_id + "_pTRatio34", 
                .5, -5, 5, .1, 0, 1, ";p_{T} Ratio_{34}", ";#Delta#eta_{34}", 
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "dEta34", "pTRatio34");

	    //------------------------dEta12&34 vs dPhi12&34-----------------------------// skipto
            m_outMngrHist -> AddStandardTH2( "dEta12", "truth_" + type + str_id + "_dPhi12", 
                .2, -5, 5, .2, -1*TMath::Pi(), TMath::Pi(), ";#Delta#phi_{12}", ";#Delta#eta_{12}", 
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "dEta12", "dPhi12");
            m_outMngrHist -> AddStandardTH2( "dEta34", "truth_" + type + str_id + "_dPhi34", 
                .2, -5, 5, .2, -1*TMath::Pi(), TMath::Pi(), ";#Delta#phi_{34}", ";#Delta#eta_{34}", 
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "dEta34", "dPhi34");
	    ...
	    //------------------------2D pT Decay Origin-----------------------------//
            m_outMngrHist -> AddStandardTH2( "leadingPtOrigin", "truth_" + type + str_id + "_subLeadingPtOrigin", 
                1, 0, 4, 1, 0, 4, ";Subleading Decay Pt Origin", ";Leading Decay Pt Origin", //skipto
                true, &(m_outData -> o_truth_partons.at(type)), &(m_outData -> o_truth_partons.at(type)), iTT, iTT, true, "leadingPtOrigin", "subLeadingPtOrigin");

	    //------------------------Casey Truth Studies End-----------------------------//
	  }
