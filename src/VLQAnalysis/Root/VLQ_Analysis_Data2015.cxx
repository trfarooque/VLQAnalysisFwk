...
bool VLQ_Analysis_Data2015::Begin(){
  ...
  if(m_opt->DumpTree()){
    ...
    m_outMngrTree->AddStandardBranch("sampleName", "Sample name", &(m_outData->o_sampleName));
    m_outMngrTree->AddStandardBranch("mc_campaign", "MC campaign", &(m_outData->o_mc_campaign));
...
/*  m_outMngrTree->AddStandardBranch( "dPhimin_RCMHiggsRCMHiggs", ";#Delta#phi_{min}(Higgs-tagged jet, Higgs-tagged jet)", &(m_outData -> o_dPhimin_RCMHiggsRCMHiggs));
    ...
    m_outMngrTree->AddStandardBranch( "dPhimin_RCTTMassMET", ";#Delta#phi_{min}(RCTTMass, MET)", &(m_outData -> o_dPhimin_RCTTMassMET) );
    m_outMngrTree->AddStandardBranch( "dPhimin_RCjetsMET", ";#Delta#phi_{min}(RCJets, MET)", &(m_outData -> o_dPhimin_RCjetsMET) );
    m_outMngrTree->AddStandardBranch( "dPhimin_RCMTopMET", ";#Delta#phi_{min}(RCMTop, MET)", &(m_outData -> o_dPhimin_RCMTopMET) );
    m_outMngrTree->AddStandardBranch( "dPhimin_RCMHiggsMET", ";#Delta#phi_{min}(RCMHiggs, MET)", &(m_outData -> o_dPhimin_RCMHiggsMET) );
    ...
    m_outMngrTree->AddStandardBranch( "leadingdEta_RCTTMassRCTTMass", ";#Delta#Eta (leading TTmass jet, subleading TTmass jet)", &(m_outData -> o_leadingdEta_RCTTMassRCTTMass) );
     m_outMngrTree->AddStandardBranch( "leadingdPhi_RCTTMassRCTTMass", ";#Delta#phi (leading TTmass jet, subleading TTmass jet)", &(m_outData -> o_leadingdPhi_RCTTMassRCTTMass) );
     m_outMngrTree->AddStandardBranch( "leadingdPhi_RCTTMassMET", ";#Delta#phi (leading TTmass jet, MET)", &(m_outData -> o_leadingdPhi_RCTTMassMET));
    ...
    m_outMngrTree->AddStandardBranch("dPhiaverage_RCjetsMET",  ";#Delta#phi_{ave.}(rcjet,MET)", &(m_outData -> o_dPhiaverage_RCjetsMET)  );
    m_outMngrTree->AddStandardBranch("dPhiaverage_RCTTMassMET",  ";#Delta#phi_{ave.}(RCTTMass,MET)", &(m_outData -> o_dPhiaverage_RCTTMassMET)  );
    m_outMngrTree->AddStandardBranch("dPhiaverage_RCMTopMET",  ";#Delta#phi_{ave.}(RCMTop,MET)", &(m_outData -> o_dPhiaverage_RCMTopMET)  );
    m_outMngrTree->AddStandardBranch("dPhiaverage_RCMHiggsMET",  ";#Delta#phi_{ave.}(RCMHiggs,MET)", &(m_outData -> o_dPhiaverage_RCMHiggsMET)  );

    m_outMngrTree->AddStandardBranch("dRaverage_RCTTMassRCTTMass",  ";#DeltaR_{ave.}(RCTTMass,RCTTMass)", &(m_outData -> o_dRaverage_RCTTMassRCTTMass)  );
    m_outMngrTree->AddStandardBranch("dEtaaverage_RCTTMassRCTTMass",  ";#Delta#eta_{ave.}(RCTTMass,RCTTMass)", &(m_outData -> o_dEtaaverage_RCTTMassRCTTMass)  );
    m_outMngrTree->AddStandardBranch("dPhiaverage_RCTTMassRCTTMass",  ";#Delta#phi_{ave.}(RCTTMass,RCTTMass)", &(m_outData -> o_dPhiaverage_RCTTMassRCTTMass)  );
  
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_pt",  ";reco mass of VLQs by pt [GeV]",  &(m_outData->o_m_vlq_rcjets_pt) ,-1,"" );   
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcjets_pt",  ";fraction of mass asymmetry of rec VLQs by pt",  &(m_outData->o_fmasymm_vlq_rcjets_pt)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_detamin",  ";reco mass of VLQs by detamin [GeV]",  &(m_outData->o_m_vlq_rcjets_detamin)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcjets_detamin",  ";fraction of mass asymmetry of rec VLQs by detamin",  &(m_outData->o_fmasymm_vlq_rcjets_detamin)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_drmax",  ";reco mass of VLQs by drmax [GeV]",  &(m_outData->o_m_vlq_rcjets_drmax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcjets_drmax",  ";fraction of mass asymmetry of rec VLQs by drmax ",  &(m_outData->o_fmasymm_vlq_rcjets_drmax),-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_dphimax",  ";reco mass of VLQs by dphimax[GeV]",  &(m_outData->o_m_vlq_rcjets_dphimax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcjets_dphimax",  ";fraction of mass asymmetry of rec VLQs by dphimax",  &(m_outData->o_fmasymm_vlq_rcjets_dphimax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_dphimax_n", ";number of reco mass of VLQs by dphimax[GeV]",  &(m_outData->o_m_vlq_rcjets_dphimax_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_detamin_n", ";number of reco mass of VLQs by detamin[GeV]",  &(m_outData->o_m_vlq_rcjets_detamin_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_drmax_n", ";number of reco mass of VLQs by drmax[GeV]",  &(m_outData->o_m_vlq_rcjets_drmax_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcjets_pt_n", ";number of reco mass of VLQs by pt[GeV]",  &(m_outData->o_m_vlq_rcjets_pt_n)  ,-1,"" );

    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_pt",  ";reco mass of VLQs by pt [GeV]",  &(m_outData->o_m_vlq_rcttmass_pt) ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcttmass_pt",  ";fraction of mass asymmetry of rec VLQs by pt",  &(m_outData->o_fmasymm_vlq_rcttmass_pt)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_detamin",  ";reco mass of VLQs by detamin [GeV]",  &(m_outData->o_m_vlq_rcttmass_detamin)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcttmass_detamin",  ";fraction of mass asymmetry of rec VLQs by detamin",  &(m_outData->o_fmasymm_vlq_rcttmass_detamin)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_drmax",  ";reco mass of VLQs by drmax [GeV]",  &(m_outData->o_m_vlq_rcttmass_drmax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcttmass_drmax",  ";fraction of mass asymmetry of rec VLQs by drmax ",  &(m_outData->o_fmasymm_vlq_rcttmass_drmax),-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_dphimax",  ";reco mass of VLQs by dphimax[GeV]",  &(m_outData->o_m_vlq_rcttmass_dphimax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("fmasymm_vlq_rcttmass_dphimax",  ";fraction of mass asymmetry of rec VLQs by dphimax",  &(m_outData->o_fmasymm_vlq_rcttmass_dphimax)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_dphimax_n", ";number of reco mass of VLQs by dphimax[GeV]",  &(m_outData->o_m_vlq_rcttmass_dphimax_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_detamin_n", ";number of reco mass of VLQs by detamin[GeV]",  &(m_outData->o_m_vlq_rcttmass_detamin_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_drmax_n", ";number of reco mass of VLQs by drmax[GeV]",  &(m_outData->o_m_vlq_rcttmass_drmax_n)  ,-1,"" );
    m_outMngrTree -> AddStandardBranch("m_vlq_rcttmass_pt_n", ";number of reco mass of VLQs by pt[GeV]",  &(m_outData->o_m_vlq_rcttmass_pt_n)  ,-1,"" );
    
    m_outMngrTree -> AddStandardBranch( "RCjets_n",    ";Number of signal RC jets", &(m_outData -> o_rcjets_n) );
   
    //leptop information trees
    for ( const std::string type : {"RCTTMass","RCMTop","RCMHiggs","RCMV" } ){

      m_outMngrTree -> AddStandardBranch( type + "_jets_n", ";Number of "+type+" jets", &(m_outData -> o_taggedjets_n.at(type)) ); 
      m_outMngrTree->AddStandardBranch( type + "_jet" + "s" + "_reff", ";"+type+" jet"+"s"+" R_{eff} [GeV]" , &(m_outData -> o_taggedjets.at(type)), -1, "reff" );
      m_outMngrTree -> AddStandardBranch( type + "_jet" + "s" + "_pt", ";"+type+" jet"+"s"+" p_{T} [GeV]" ,
					  &(m_outData -> o_taggedjets.at(type)), -1, "Pt" );
      m_outMngrTree -> AddStandardBranch( type + "_jet" + "s" + "_eta", ";"+type+" jet"+"s"+" #eta"        ,
					  &(m_outData -> o_taggedjets.at(type)), -1, "Eta" );
      m_outMngrTree -> AddStandardBranch( type + "_jet" + "s" + "_m", ";"+type+" jet"+"s"+" mass [GeV]"    ,
					  &(m_outData -> o_taggedjets.at(type)), -1, "M" );
      m_outMngrTree -> AddStandardBranch( type + "_jet" +"s"+ "_bconsts_n", ";"+type+" jet"+"s"+" N_{subjets}^{b-tagged}",
	...
	m_outMngrTree -> AddStandardBranch( "RCjet"+str_id+"_isRCTTMass",  ";Mass Tag"          ,      &(m_outData -> o_rcjets), iRCJet, "isRCTTMass");
	m_outMngrTree -> AddStandardBranch( "RCjet"+str_id+"_isRCMTop",  ";Top Mass Tag"          ,      &(m_outData -> o_rcjets), iRCJet, "isRCMTop");
	m_outMngrTree -> AddStandardBranch( "RCjet"+str_id+"_isRCMHiggs",  ";Higgs Mass Tag"          ,      &(m_outData -> o_rcjets), iRCJet, "isRCMHiggs");
    ...
    m_outMngrTree -> AddStandardBranch( "leptop_m", ";Leptonic top Mass " , &(m_outData -> o_leptop), -1, "M");
    m_outMngrTree -> AddStandardBranch( "leptop_dR_bW", ";Leptonic top #DeltaR(b,W)" , &(m_outData -> o_leptop), -1, "dR_bW");
    ...
    m_outMngrTree -> AddStandardBranch( "nu_eta", ";Neutrino #eta"             ,   &(m_outData -> o_nu), -1, "Eta" );
    m_outMngrTree -> AddStandardBranch( "nu_m",   ";Neutrino mass [GeV]"       ,   &(m_outData -> o_nu), -1, "M" );
    m_outMngrTree -> AddStandardBranch( "nu_fracMET", ";Neutrino MET fraction"     ,   &(m_outData -> o_nu), -1, "fracMET" );
    m_outMngrTree -> AddStandardBranch( "nu_dphi_MET", ";#Delta#phi(Neutrino, MET)" ,   &(m_outData -> o_nu), -1, "dphi_MET" );
    m_outMngrTree -> AddStandardBranch( "nu_N_soln", ";Number of #nu solutions" ,   &(m_outData -> o_nu), -1, "N_soln" );

    m_outMngrTree -> AddStandardBranch( "residualMET_M",   "Residual MET (met-#nu_met) M [GeV]",  &(m_outData -> o_residualMET),-1,"M" );
 ...
 */
  ...
  if(m_opt->DumpHistos()){
    ...
    const int hopt_nouoflow = HistManager::FCHECK;
    ...
    if( DrawReco ){
      ...
      m_outMngrHist->AddStandardTH2("leptop_n", "hadtop_n", 1, 0, 2, 1, 0, 6, ";Number of leptonic tops", ";Number of hadronic tops", false, 
				    &(m_outData->o_leptop_n),  &(m_outData->o_taggedjets_n.at("RCMTop")));
      m_outMngrHist->AddStandardTH2("leptop_n", "RCTTMass_jets_n", 1, 0, 2, 1, 0, 6, ";Number of leptonic tops", ";Number of RCTTMass jets", false,
                                    &(m_outData->o_leptop_n),  &(m_outData->o_taggedjets_n.at("RCTTMass")));
      m_outMngrHist->AddStandardTH2("RCJets_n", "MVAScore", 1, 0, 6, 0.050,-0.1, 1.05, ";Number of signal RC jets", ";MVA Score", false,
				    &(m_outData -> o_rcjets_n), &(m_outData -> o_MVAScore));
      ...
      */
      ...
      m_outMngrHist -> AddStandardTH1( "leptop_pt",         50, 0, 2000, ";Leptonic top p_{T} [GeV]" ,  otherVariables, &(m_outData -> o_leptop), -1, "Pt", hopt_nouflow);
	...
	if(DrawTruth){
	 ...
	 ,  false, &(m_outData -> o_catLeptop.at(lptype)), -1, "nmatch_truth");
      ...
      m_outMngrHist -> AddStandardTH1( "lepW_n",     1, -0.5, 1.5, ";Number of (reconstructed) leptopnic W", otherVariables, &(m_outData -> o_lepW_n) );
      ...
      m_outMngrHist -> AddStandardTH1( "nu_N_soln",   1, 0, 3,   ";Number of #nu solutions" ,  false, &(m_outData -> o_nu), -1, "N_soln", hopt_nouflow);
	...
	if(iJet==-1) str_id = "s";
	const bool DrawSyst = (iJet <= 0) && otherVariables;
	m_outMngrHist -> AddStandardTH1( "jet"+str_id+"_pt",    10, 0, 2000,     ";Jet"+str_id+" p_{T} [GeV]",  DrawSyst,
	...
	m_outMngrHist -> AddStandardTH1( type+"_RCjets_n", 1, -0.5, 4.5, ";Number of truth "+tagstring+" RC jets"
					 , true, &(m_outData -> o_rcjets_truthmatched_n.at(type)));
      }//TruthRC types
    }
    if(m_opt->VerboseOutput()){
	...
	for ( int iTT =-1; iTT <=1; ++iTT ) {
	  ...
	  if(DrawReco){
	    ...
	    /*if(m_opt->DoRecoVLQ() == "pair"){

	      m_outMngrHist -> AddStandardTH1(decayType + "_recoVLQ" +str_id + "_mAsymm", 50, 0, 5000, ";"+decayType+" reco VLQ"+str_id+" mass asymmetry [GeV]",
					      true, &(m_outData -> o_recoVLQ.at(decayType)), iTT, "mAsymm");
      ...
      if(DrawReco && m_opt->DoRecoVLQ() == "pair"){

	m_outMngrHist -> AddStandardTH1("recoHtHt_minMAsymm", 50, -50, 5000, ";reco HtHt min mass asymmetry [GeV]", otherVariables, &(m_outData->o_minRecoVLQMAsymm_HtHt) ); 
	m_outMngrHist -> AddStandardTH1("recoHtZt_minMAsymm", 50, -50, 5000, ";reco HtZt min mass asymmetry [GeV]", otherVariables, &(m_outData->o_minRecoVLQMAsymm_HtZt) );
	m_outMngrHist -> AddStandardTH1("recoHtWb_minMAsymm", 50, -50, 5000, ";reco HtWb min mass asymmetry [GeV]", otherVariables, &(m_outData->o_minRecoVLQMAsymm_HtWb) );
	
      }
      //VLQ mass reconstruction
      /*if(DrawReco){

	m_outMngrHist -> AddStandardTH1("m_vlq_pt", 50, 0, 5000, ";reco mass of VLQs by pt [GeV]", true, &(m_outData->o_m_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("averagem_vlq_pt", 50, 0, 5000, ";average reco mass of VLQs by pt[GeV]", true, &(m_outData->o_averagem_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("masymm_vlq_pt", 50, 0, 5000, ";mass asymetry of reco VLQs by pt [GeV]", true, &(m_outData->o_masymm_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("fmasymm_vlq_pt", 0.2, -2, 2, ";fraction of mass asymmetry of rec VLQs by pt [GeV]", true, &(m_outData->o_fmasymm_vlq_pt) ); 

	m_outMngrHist -> AddStandardTH1("m_vlq_detamin", 50, 0, 5000, ";reco mass of VLQs by detamin [GeV]", true, &(m_outData->o_m_vlq_detamin) ); 
	m_outMngrHist -> AddStandardTH1("averagem_vlq_detamin", 50, 0, 5000, ";average reco mass of VLQs by detamin[GeV]", true, &(m_outData->o_averagem_vlq_detamin) );
	m_outMngrHist -> AddStandardTH1("masymm_vlq_detamin", 50, 0, 5000, ";mass asymetry of reco VLQs by detamin [GeV]", true, &(m_outData->o_masymm_vlq_detamin) ); 
	m_outMngrHist -> AddStandardTH1("fmasymm_vlq_detamin", 0.2, -2, 2, ";fraction of mass asymmetry of rec VLQs by detamin [GeV]", true, &(m_outData->o_fmasymm_vlq_detamin) ); 
	m_outMngrHist -> AddStandardTH1("m_vlq_drmin", 50, 0, 5000, ";reco mass of VLQs by drmin [GeV]", true, &(m_outData->o_m_vlq_drmin) ); 
	m_outMngrHist -> AddStandardTH1("averagem_vlq_drmin", 50, 0, 5000, ";average reco mass of VLQs by drmin[GeV]", true, &(m_outData->o_averagem_vlq_drmin) ); 
	m_outMngrHist -> AddStandardTH1("masymm_vlq_drmin", 50, 0, 5000, ";mass asymetry of reco VLQs by drmin [GeV]", true, &(m_outData->o_masymm_vlq_drmin) ); 
	m_outMngrHist -> AddStandardTH1("fmasymm_vlq_drmin", 0.2, -2, 2, ";fraction of mass asymmetry of rec VLQs by drmin [GeV]", true, &(m_outData->o_fmasymm_vlq_drmin) ); 
	m_outMngrHist -> AddStandardTH1("m_vlq_pt", 50, 0, 5000, ";reco mass of VLQs by dphimax[GeV]", true, &(m_outData->o_m_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("averagem_vlq_pt", 50, 0, 5000, ";average reco mass of VLQs by pt[GeV]", true, &(m_outData->o_averagem_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("masymm_vlq_pt", 50, 0, 5000, ";mass asymetry of reco VLQs by dphimax[GeV]", true, &(m_outData->o_masymm_vlq_pt) ); 
	m_outMngrHist -> AddStandardTH1("fmasymm_vlq_pt", 0.2, -2, 2, ";fraction of mass asymmetry of rec VLQs by dphimax[GeV]", true, &(m_outData->o_fmasymm_vlq_pt) ); 
      }*/
    ...
    if(DrawTruth){
      ...
      //======= Leptonic W ======
      m_outMngrHist -> AddStandardTH1( "lepW_pT_truth",   50, 0, 2500, ";Leptonic W p_{T}^{truth} [GeV]" ,  false, &(m_outData -> o_lepW), -1, "pT_truth");
      m_outMngrHist -> AddStandardTH1( "lepW_fpT_truth",   0.1, 0., 2., ";Leptonic W p_{T}^{reco}/p_{T}^{truth}" ,  false, &(m_outData -> o_lepW), -1, "fpT_truth");
      m_outMngrHist -> AddStandardTH1( "lepW_dR_truth",   0.1, 0., 6., ";Leptonic W #DeltaR^{truth}" ,  false, &(m_outData -> o_lepW), -1, "dR_truth");
      m_outMngrHist -> AddStandardTH1( "lepW_nmatch_truth",   1, 0, 2, ";Leptonic W isTruthMatched" ,  false, &(m_outData -> o_lepW), -1, "nmatch_truth");
    ...
    if((m_opt->VerboseOutput() && DrawReco) || m_opt->ApplyMVA()){
      ...
      m_outMngrHist -> AddStandardTH1( "dRmin_RCMHiggsRCMTop", 0.25,0,5, ";#DeltaR_{min}(Higgs-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dRmin_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dRmin_RCMVRCMV", 0.25,0,5, ";#DeltaR_{min}(W/Z-tagged jet, W/Z-tagged jet)", otherVariables, &(m_outData -> o_dRmin_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "dRmin_RCMVRCMTop", 0.25,0,5, ";#DeltaR_{min}(W/Z-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dRmin_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dRmin_RCMTopRCMTop", 0.25,0,5, ";#DeltaR_{min}(Top-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dRmin_RCMTopRCMTop) );
     
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMHiggsRCMHiggs", 0.25,-1,5, ";#Delta#phi_{min}(Higgs-tagged jet, Higgs-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMHiggsRCMHiggs) );
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMHiggsRCMV", 0.25,-1,5, ";#Delta#phi_{min}(Higgs-tagged jet, W/Z-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMHiggsRCMV) );
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMHiggsRCMTop", 0.25,-1,5, ";#Delta#phi_{min}(Higgs-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMVRCMV", 0.25,-1,5, ";#Delta#phi_{min}(W/Z-tagged jet, W/Z-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMVRCMTop", 0.25,-1,5, ";#Delta#phi_{min}(W/Z-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dPhimin_RCMTopRCMTop", 0.25,-1,5, ";#Delta#phi_{min}(Top-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dPhimin_RCMTopRCMTop) );
     

      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMHiggsRCMHiggs", 0.25,-1,5, ";#Delta#eta_{min}(Higgs-tagged jet, Higgs-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMHiggsRCMHiggs) );
      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMHiggsRCMV", 0.25,-1,5, ";#Delta#eta_{min}(Higgs-tagged jet, W/Z-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMHiggsRCMV) );
      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMHiggsRCMTop", 0.25,-1,5, ";#Delta#eta_{min}(Higgs-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMVRCMV", 0.25,-1,5, ";#Delta#eta_{min}(W/Z-tagged jet, W/Z-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMVRCMTop", 0.25,-1,5, ";#Delta#eta_{min}(W/Z-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "dEtamin_RCMTopRCMTop", 0.25,-1,5, ";#Delta#eta_{min}(Top-tagged jet, Top-tagged jet)", otherVariables, &(m_outData -> o_dEtamin_RCMTopRCMTop) );
     

 m_outMngrHist -> AddStandardTH1( "dEtamin_RCTTMassRCTTMass", 0.25,-1,5, ";#Delta#eta_{min}(RCTTMass, RCTTMass)", otherVariables, &(m_outData -> o_dEtamin_RCTTMassRCTTMass) );
 m_outMngrHist -> AddStandardTH1( "dRmin_RCTTMassRCTTMass", 0.25,-1,5, ";#DeltaR_{min}(RCTTMass, RCTTMass)", otherVariables, &(m_outData -> o_dRmin_RCTTMassRCTTMass) );
 m_outMngrHist -> AddStandardTH1( "dPhimin_RCTTMassRCTTMass", 0.25,-1,5, ";#Delta#phi_{min}(RCTTMass, RCTTMass)", otherVariables, &(m_outData -> o_dPhimin_RCTTMassRCTTMass) );

 m_outMngrHist -> AddStandardTH1( "dPhimin_RCTTMassMET", 0.25,-1,5,  ";#Delta#phi_{min}(RCTTMass, MET)", otherVariables,  &(m_outData -> o_dPhimin_RCTTMassMET), hopt_nouoflow );
 m_outMngrHist -> AddStandardTH1( "dPhimin_RCjetsMET", 0.25,-1,5,  ";#Delta#phi_{min}(RCJets, MET)", otherVariables,  &(m_outData -> o_dPhimin_RCjetsMET), hopt_nouoflow );
 m_outMngrHist -> AddStandardTH1( "dPhimin_RCMTopMET", 0.25,-1,5, ";#Delta#phi_{min}(RCMTop, MET)", otherVariables,  &(m_outData -> o_dPhimin_RCMTopMET), hopt_nouoflow );
 m_outMngrHist -> AddStandardTH1( "dPhimin_RCMHiggsMET", 0.25,-1,5,  ";#Delta#phi_{min}(RCMHiggs, MET)", otherVariables, &(m_outData -> o_dPhimin_RCMHiggsMET), hopt_nouoflow );

     


      m_outMngrHist -> AddStandardTH1( "leadingdR_RCTTMassRCTTMass", 0.25,-1,5, ";#DeltaR (leading TTmass jet, subleading TTmass jet)", otherVariables, &(m_outData -> o_leadingdR_RCTTMassRCTTMass) );
  
    m_outMngrHist -> AddStandardTH1( "leadingdEta_RCTTMassRCTTMass", 0.25,-1,5, ";#DeltaR (leading TTmass jet, subleading TTmass jet)", otherVariables, &(m_outData -> o_leadingdEta_RCTTMassRCTTMass) );
  
    m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCTTMassRCTTMass", 0.25,-1,5, ";#DeltaR (leading TTmass jet, subleading TTmass jet)", otherVariables, &(m_outData -> o_leadingdPhi_RCTTMassRCTTMass) );


    m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCTTMassMET", 0.25,-1,5, ";#Delta#phi (leading TTmass jet, MET)", otherVariables, &(m_outData -> o_leadingdPhi_RCTTMassMET), hopt_nouoflow );
    m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCjetsMET", 0.25,-1,5, ";#Delta#phi (leading RC jet, MET)", otherVariables,  &(m_outData -> o_leadingdPhi_RCjetsMET), hopt_nouoflow );
    m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMTopMET", 0.25,-1,5, ";#Delta#phi (leading Top jet, MET)", otherVariables, &(m_outData -> o_leadingdPhi_RCMTopMET), hopt_nouoflow );
    m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMHiggsMET", 0.25,-1,5, ";#Delta#phi (leading Higgs jet, MET)", otherVariables, &(m_outData -> o_leadingdPhi_RCMHiggsMET), hopt_nouoflow );
  

      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMHiggsRCMHiggs", 0.25,-1,5, ";#DeltaR (leading Higgs-tagged J, subleading Higgs-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMHiggsRCMHiggs) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMHiggsRCMV", 0.25,-1,5, ";#DeltaR (leading Higgs-tagged J, leading W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMHiggsRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMHiggsRCMTop", 0.25,-1,5, ";#DeltaR (leading Higgs-tagged J, leading Top-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMVRCMV", 0.25,-1,5, ";#DeltaR (leading W/Z-tagged J, subleading W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMVRCMTop", 0.25,-1,5, ";#DeltaR (leading W/Z-tagged J, leading Top-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCMTopRCMTop", 0.25,-1,5, ";#DeltaR (leading Top-tagged J, subleading Top-tagged J)", otherVariables, &(m_outData -> o_leadingdR_RCMTopRCMTop) );

      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMHiggsRCMHiggs", 0.25,-1,5, ";leading#Delta#eta (leadingd Higgs-tagged J, subleadingd Higgs-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMHiggsRCMHiggs) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMHiggsRCMV", 0.25,-1,5, ";leading#Delta#eta (leadingd Higgs-tagged J, leadingd W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMHiggsRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMHiggsRCMTop", 0.25,-1,5, ";leading#Delta#eta (leadingd Higgs-tagged J, leadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMVRCMV", 0.25,-1,5, ";leading#Delta#eta (leadingd W/Z-tagged J, subleadingd W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMVRCMTop", 0.25,-1,5, ";leading#Delta#eta (leadingd W/Z-tagged J, leadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCMTopRCMTop", 0.25,-1,5, ";leading#Delta#eta (leadingd Top-tagged J, subleadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdEta_RCMTopRCMTop) );

      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMHiggsRCMHiggs", 0.25,-1,5, ";leading#Delta#phi (leadingd Higgs-tagged J, subleadingd Higgs-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMHiggsRCMHiggs) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMHiggsRCMV", 0.25,-1,5, ";leading#Delta#phi (leadingd Higgs-tagged J, leadingd W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMHiggsRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMHiggsRCMTop", 0.25,-1,5, ";leading#Delta#phi (leadingd Higgs-tagged J, leadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMHiggsRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMVRCMV", 0.25,-1,5, ";leading#Delta#phi (leadingd W/Z-tagged J, subleadingd W/Z-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMVRCMV) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMVRCMTop", 0.25,-1,5, ";leading#Delta#phi (leadingd W/Z-tagged J, leadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMVRCMTop) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCMTopRCMTop", 0.25,-1,5, ";leading#Delta#phi (leadingd Top-tagged J, subleadingd Top-tagged J)", otherVariables, &(m_outData -> o_leadingdPhi_RCMTopRCMTop) );

      m_outMngrHist -> AddStandardTH1( "leadingdPhi_lepjet", 0.25,-1,5, ";leading#Delta#phi (lep,jet)", otherVariables, &(m_outData -> o_leadingdPhi_lepjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_lepbjet", 0.25,-1,5, ";leading#Delta#phi (lep,bjet)", otherVariables, &(m_outData  -> o_leadingdPhi_lepbjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_jetjet", 0.25,-1,5, ";leading#Delta#phi (jet,jet)", otherVariables, &(m_outData -> o_leadingdPhi_jetjet) );
      
      m_outMngrHist -> AddStandardTH1( "leadingdR_lepjet", 0.25,0,5, ";leading#Delta#R (lep,jet)", otherVariables, &(m_outData -> o_leadingdR_lepjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_lepbjet", 0.25,0,5, ";leading#Delta#R (lep,bjet)", otherVariables, &(m_outData  -> o_leadingdR_lepbjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdR_jetjet", 0.25,0,5, ";leading#Delta#R (jet,jet)", otherVariables, &(m_outData -> o_leadingdR_jetjet) );
      
      m_outMngrHist -> AddStandardTH1( "leadingdEta_lepjet", 0.25,0,5, ";leading#Delta#eta (lep,jet)", otherVariables, &(m_outData -> o_leadingdEta_lepjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_lepbjet", 0.25,0,5, ";leading#Delta#eta (lep,bjet)", otherVariables, &(m_outData  -> o_leadingdEta_lepbjet) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_jetjet", 0.25,0,5, ";leading#Delta#eta (jet,jet)", otherVariables, &(m_outData -> o_leadingdEta_jetjet) );
      
      m_outMngrHist -> AddStandardTH1( "leadingdR_RCjets", 0.25,-1,5, ";leading#Delta#R (rcjet,rcjet)", otherVariables, &(m_outData -> o_leadingdR_RCjets) );
      m_outMngrHist -> AddStandardTH1( "leadingdPhi_RCjets", 0.25,-1,5, ";leading#Delta#phi (rcjet,rcjet)", otherVariables, &(m_outData -> o_leadingdPhi_RCjets) );
      m_outMngrHist -> AddStandardTH1( "leadingdEta_RCjets", 0.25,-1,5, ";leading#Delta#eta (rcjet,rcjet)", otherVariables, &(m_outData -> o_leadingdEta_RCjets) );
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_pt", 50, 0, 5000, ";reco mass of VLQs by pt [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_pt),-1 ,"", hopt_nouflow );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_pt1", 50, 0, 5000, ";reco mass of VLQs by pt 0[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_pt),0, "", hopt_nouflow );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_pt2", 50, 0, 5000, ";reco mass of VLQs by pt 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_pt),1,"", hopt_nouflow  );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_detamin1", 50, 0, 5000, ";reco mass of VLQs by detamin 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_detamin),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_detamin2", 50, 0, 5000, ";reco mass of VLQs by detamin 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_detamin),1,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_drmax1", 50, 0, 5000, ";reco mass of VLQs by drmax 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_drmax),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_drmax2", 50, 0, 5000, ";reco mass of VLQs by drmax 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_drmax),1,"",hopt_nouflow);
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_dphimax1", 50, 0, 5000, ";reco mass of VLQs by dphimax 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_dphimax),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_dphimax2", 50, 0, 5000, ";reco mass of VLQs by dphimax 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_dphimax),1,"",hopt_nouflow);
      
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcjets_pt", 50, 0, 5000, ";average reco mass of VLQs by pt[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcjets_pt)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcjets_pt", 50, -3500, 3500, ";mass asymetry of reco VLQs by pt [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcjets_pt)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcjets_pt", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by pt", otherVariables, &(m_outData->o_fmasymm_vlq_rcjets_pt)  ,-1,"", hopt_nouflow); 
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_detamin", 50, 0, 5000, ";reco mass of VLQs by detamin [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcjets_detamin", 50, 0, 5000, ";average reco mass of VLQs by detamin[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcjets_detamin) ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcjets_detamin", 50, -3500, 3500, ";mass asymetry of reco VLQs by detamin [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcjets_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcjets_detamin", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by detamin", otherVariables, &(m_outData->o_fmasymm_vlq_rcjets_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_drmax", 50, 0, 5000, ";reco mass of VLQs by drmax [GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_drmax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcjets_drmax", 50, 0, 5000, ";average reco mass of VLQs by drmax[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcjets_drmax), -1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcjets_drmax", 50, -3500, 3500, ";mass asymetry of reco VLQs by drmax [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcjets_drmax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcjets_drmax", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by drmax ", otherVariables, &(m_outData->o_fmasymm_vlq_rcjets_drmax) ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_dphimax", 50, 0, 5000, ";reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcjets_dphimax", 50, 0, 5000, ";average reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcjets_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcjets_dphimax", 50, -3500, 3500, ";mass asymetry of reco VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcjets_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcjets_dphimax", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by dphimax", otherVariables, &(m_outData->o_fmasymm_vlq_rcjets_dphimax)  ,-1,"", hopt_nouflow);
      
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_dphimax_n", 1, 0, 50, ";number of reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_dphimax_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_detamin_n", 1, 0, 50, ";number of reco mass of VLQs by detamin[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_detamin_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_drmax_n", 1, 0, 50, ";number of reco mass of VLQs by drmax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_drmax_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcjets_pt_n", 1, 0, 50, ";number of reco mass of VLQs by pt[GeV]", otherVariables, &(m_outData->o_m_vlq_rcjets_pt_n)  ,-1,"", hopt_nouflow);
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_pt", 50, 0, 5000, ";reco mass of VLQs by pt [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_pt),-1 ,"", hopt_nouflow );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_pt1", 50, 0, 5000, ";reco mass of VLQs by pt 0[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_pt),0, "", hopt_nouflow );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_pt2", 50, 0, 5000, ";reco mass of VLQs by pt 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_pt),1,"", hopt_nouflow  );
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_detamin1", 50, 0, 5000, ";reco mass of VLQs by detamin 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_detamin),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_detamin2", 50, 0, 5000, ";reco mass of VLQs by detamin 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_detamin),1,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_drmax1", 50, 0, 5000, ";reco mass of VLQs by drmax 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_drmax),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_drmax2", 50, 0, 5000, ";reco mass of VLQs by drmax 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_drmax),1,"",hopt_nouflow);
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_dphimax1", 50, 0, 5000, ";reco mass of VLQs by dphimax 0 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_dphimax),0,"",hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_dphimax2", 50, 0, 5000, ";reco mass of VLQs by dphimax 1 [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_dphimax),1,"",hopt_nouflow);
      
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcttmass_pt", 50, 0, 5000, ";average reco mass of VLQs by pt[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcttmass_pt)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcttmass_pt", 50, -3500, 3500, ";mass asymetry of reco VLQs by pt [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcttmass_pt)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcttmass_pt", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by pt", otherVariables, &(m_outData->o_fmasymm_vlq_rcttmass_pt)  ,-1,"", hopt_nouflow); 
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_detamin", 50, 0, 5000, ";reco mass of VLQs by detamin [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcttmass_detamin", 50, 0, 5000, ";average reco mass of VLQs by detamin[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcttmass_detamin) ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcttmass_detamin", 50, -3500, 3500, ";mass asymetry of reco VLQs by detamin [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcttmass_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcttmass_detamin", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by detamin", otherVariables, &(m_outData->o_fmasymm_vlq_rcttmass_detamin)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_drmax", 50, 0, 5000, ";reco mass of VLQs by drmax [GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_drmax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcttmass_drmax", 50, 0, 5000, ";average reco mass of VLQs by drmax[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcttmass_drmax), -1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcttmass_drmax", 50, -3500, 3500, ";mass asymetry of reco VLQs by drmax [GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcttmass_drmax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcttmass_drmax", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by drmax ", otherVariables, &(m_outData->o_fmasymm_vlq_rcttmass_drmax) ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_dphimax", 50, 0, 5000, ";reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("averagem_vlq_rcttmass_dphimax", 50, 0, 5000, ";average reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_averagem_vlq_rcttmass_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("masymm_vlq_rcttmass_dphimax", 50, -3500, 3500, ";mass asymetry of reco VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_masymm_vlq_rcttmass_dphimax)  ,-1,"", hopt_nouflow); 
      m_outMngrHist -> AddStandardTH1("fmasymm_vlq_rcttmass_dphimax", 0.2, -3, 3, ";fraction of mass asymmetry of rec VLQs by dphimax", otherVariables, &(m_outData->o_fmasymm_vlq_rcttmass_dphimax)  ,-1,"", hopt_nouflow);
      
      
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_dphimax_n", 1, 0, 50, ";number of reco mass of VLQs by dphimax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_dphimax_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_detamin_n", 1, 0, 50, ";number of reco mass of VLQs by detamin[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_detamin_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_drmax_n", 1, 0, 50, ";number of reco mass of VLQs by drmax[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_drmax_n)  ,-1,"", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1("m_vlq_rcttmass_pt_n", 1, 0, 50, ";number of reco mass of VLQs by pt[GeV]", otherVariables, &(m_outData->o_m_vlq_rcttmass_pt_n)  ,-1,"", hopt_nouflow);
	...
	for ( int iTT =-1; iTT <=1; ++iTT ) {
	  ...
	  if(type=="hadtop" || type=="leptop"){
	    ...
	    if(type=="tautop"){
              m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dR_blep",  0.25,0,5,  "; truth"+type+", "+str_id+" #DeltaR(b,tau)\
"
                                               , false, &(m_outData -> o_truth_partons.at(type)), iTT, "dR_blep"/*, hopt_nouflow*/  );
              m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi_blep",  0.1,0.,4,  "; truth"+type+", "+str_id+" #Delta#phi(b\
,tau)"
                                               , false, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi_blep"/*, hopt_nouflow*/  );
              m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_dPhi_bnu",  0.1,0.,4,  "; truth"+type+", "+str_id+" #Delta#phi(b,\
#nu)"
                                               , false, &(m_outData -> o_truth_partons.at(type)), iTT, "dPhi_bnu"/*, hopt_nouflow*/  );
              m_outMngrHist -> AddStandardTH1( "truth_" + type + str_id + "_mT_bnu", 25, 0, 3000, "; truth "+type+", "+str_id+" m_{T}(b,#nu) \
[GeV]"    ,
                                               false, &(m_outData -> o_truth_partons.at(type)), iTT, "mT_bnu"/*, hopt_nouflow*/ );
            }//tautop
...
bool VLQ_Analysis_Data2015::Process(Long64_t entry)
{
  ...
  if( !(m_opt -> IsData() || (m_opt -> StrSampleName().find("QCD") != std::string::npos)) && m_truthMngr ){
    ...
    if(m_opt -> DoTruthAnalysis()){
      ...
      if( m_opt -> SampleName() == SampleName::VLQ ){ heavy_list = { "leptop","tautop", "hadtop", "hadtop_W", "Hbb", "Hnonbb", "hadW", "hadZ" }; }
      if( m_outData -> o_is_ttbar ){ heavy_list = {"leptop","tautop", "hadtop", "hadtop_W"}; }
    ...
    if( (m_outData -> o_leptop) && (m_outData -> o_leptop_b) ){ 
      ...
      if( (m_outData -> o_leptop)->IsKnownMoment("nmatch_truth") && (m_outData -> o_leptop)->GetMoment("nmatch_truth") > 0 ){
        m_outData -> o_catLeptop.at("truthMatch")  = m_outData -> o_leptop;
        m_outData -> o_catLeptop_b.at("truthMatch")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("truthMatch")++;
      }
      else{
        m_outData -> o_catLeptop.at("nontruthMatch")  = m_outData -> o_leptop;
        m_outData -> o_catLeptop_b.at("nontruthMatch")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("nontruthMatch")++;
      }
      if( (m_outData -> o_leptop)->GetMoment("dR_bW") < 1. ){
	m_outData -> o_catLeptop.at("lowdRbW")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("lowdRbW")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("lowdRbW")++;
      }
      else if( (m_outData -> o_leptop)->GetMoment("dR_bW") > 1. ){
	m_outData -> o_catLeptop.at("highdRbW")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("highdRbW")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("highdRbW")++;
      }
      if( (m_outData -> o_leptop)->M() > 300. ){
	m_outData -> o_catLeptop.at("highM")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("highM")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("highM")++;
      }
      else if( ((m_outData -> o_leptop)->M() > 100.) && ((m_outData -> o_leptop)->M() < 300.) ){
	m_outData -> o_catLeptop.at("winM")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("winM")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("winM")++;
      }
      if( (m_outData -> o_leptop_b)->GetMoment("RCtag_match") > 0 ){ 
	m_outData -> o_catLeptop.at("BinRCtag")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("BinRCtag")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("BinRCtag")++;

	if((m_outData -> o_leptop_b)->GetMoment("RCtag_match_nconsts") ==1){
	  m_outData -> o_catLeptop.at("BinRCtagNconst1")  = m_outData -> o_leptop;
	  m_outData -> o_catLeptop_b.at("BinRCtagNconst1")  = m_outData -> o_leptop_b;
	  m_outData -> o_catLeptop_n.at("BinRCtagNconst1")++;
	}

	if( (m_outData -> o_leptop_b)->GetMoment("RCtag_match_isRCMTop") > 0 ){ 
	  m_outData -> o_catLeptop.at("BinRCMTop")  = m_outData -> o_leptop;
	  m_outData -> o_catLeptop_b.at("BinRCMTop")  = m_outData -> o_leptop_b;
	  m_outData -> o_catLeptop_n.at("BinRCMTop")++;
	  if((m_outData -> o_leptop_b)->GetMoment("RCtag_match_nconsts") ==1){ 
	    m_outData -> o_catLeptop.at("BinRCMTopNconst1")  = m_outData -> o_leptop;
	    m_outData -> o_catLeptop_b.at("BinRCMTopNconst1")  = m_outData -> o_leptop_b;
	    m_outData -> o_catLeptop_n.at("BinRCMTopNconst1")++;
	  }
	}  
	if( (m_outData -> o_leptop_b)->GetMoment("RCtag_match_isRCMHiggs") > 0 ){
	  m_outData -> o_catLeptop.at("BinRCMHiggs")  = m_outData -> o_leptop;
	  m_outData -> o_catLeptop_b.at("BinRCMHiggs")  = m_outData -> o_leptop_b;
	  m_outData -> o_catLeptop_n.at("BinRCMHiggs")++;
	  if((m_outData -> o_leptop_b)->GetMoment("RCtag_match_nconsts") ==1){
	    m_outData -> o_catLeptop.at("BinRCMHiggsNconst1")  = m_outData -> o_leptop;
	    m_outData -> o_catLeptop_b.at("BinRCMHiggsNconst1")  = m_outData -> o_leptop_b;
	    m_outData -> o_catLeptop_n.at("BinRCMHiggsNconst1")++;	
	  }
	}
	if( (m_outData -> o_leptop_b)->GetMoment("RCtag_match_isRCMV") > 0 ){
	  m_outData -> o_catLeptop.at("BinRCMV")  = m_outData -> o_leptop;
	  m_outData -> o_catLeptop_b.at("BinRCMV")  = m_outData -> o_leptop_b;
	  m_outData -> o_catLeptop_n.at("BinRCMV")++;
	  if((m_outData -> o_leptop_b)->GetMoment("RCtag_match_nconsts") ==1){
	    m_outData -> o_catLeptop.at("BinRCMVNconst1")  = m_outData -> o_leptop;
	    m_outData -> o_catLeptop_b.at("BinRCMVNconst1")  = m_outData -> o_leptop_b;
	    m_outData -> o_catLeptop_n.at("BinRCMVNconst1")++;
	  }
	}
      }//closes RCjets
      else{
	m_outData -> o_catLeptop.at("BoutRCtag")  = m_outData -> o_leptop;
	m_outData -> o_catLeptop_b.at("BoutRCtag")  = m_outData -> o_leptop_b;
	m_outData -> o_catLeptop_n.at("BoutRCtag")++;
      }
  ...
  if( m_opt-> DoTruthAnalysis() &&  m_outData-> o_truth_partons_n.at("invZ")>0 ){
  return false;
  } //          "invZ")>0  not look at events with invZ, "invZ")==0 just look at these events
