  ...
  if(m_opt->DumpHistos()){
    ...
    if( DrawReco ){
      ...
      */
      ...
      m_outMngrHist -> AddStandardTH1( "leptop_b_truthLabel", 1, 0, 10,   ";Leptonic top truth flavour",  false, &(m_outData -> o_leptop_b),-1, "truthLabel", hopt_nouflow);
      m_outMngrHist -> AddStandardTH1( "leptop_b_isbtagged", 1, 0, 2,   ";Leptonic top b isB-tagged",  false, &(m_outData -> o_leptop_b),-1, "bjet", hopt_nouflow); 
