...
do
	...
	--outputDirSuffix=FitInputsCR_dibosons_weights_${campaign}_NOW \
	...
	--doFitRegions=true --doValidnRegions=true --doPreselection=true --doExtendedPreselection=false --doLooseSystRegions=true \
