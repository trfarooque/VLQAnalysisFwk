...
do
	...
	--outputDirSuffix=FitInputs_QCDREG_DIJET_${campaign}_NOW \
	...
	--doFitRegions=false --doValidnRegions=false --doPreselection=true --doPreselSys=true --doExtendedPreselection=false --doLooseSystRegions=true \
