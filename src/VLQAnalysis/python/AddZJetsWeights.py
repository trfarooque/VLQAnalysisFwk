...
def main(infile, weightsFile, treename, attr_mcID, attr_nTruthJets):
    ...
    #print "teename : ",treename
    #print "mcID : ",attr_mcID
    #print "truthjets : ",attr_nTruthJets
    ...
    for iEvt in range(nEvts):
        ...
        MCID = int(attr_mcID) #getattr(T, attr_mcID)
        ...
        if (
            ...
            decayType = "nolepton"
               ...
               (361300 <= MCID <= 361371) or
               (363331 <= MCID <= 363354) or
               (363436 <= MCID <= 363459) or
