...
do
	...
	producetarball=true \
        --inputDir=/nfs/at3/scratch2/farooque/MBJOutputs/tag-21.2.87-htztx-3-syst-STOPSYST/ \
        --sampleDat=samples_info.tag-21.2.87-htztx-3-syst-STOPSYST.${campaign}.dat \
	--outputDirSuffix=FitInputs_RWPARAM_STOPSYST_${campaign}_NOW \
