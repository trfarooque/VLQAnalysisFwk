# Created with MakeRegionsDictionary at 2020-05-27 21:48:56.457424
...
reg_1lep3_5jwin1bex1fjin0LTex0Hex1Vin = {
	...
	'binning':"700,800,900,1100,1300,1500,1800,3500",
	'binning_blind':"700,800,900,1100,1300,1500,1800,3500",
	'type':"SIGNAL"
}
...
reg_1lep3_5jwin2bex1fjin0Tex1Lin0Hex1Vin = {
	...
	'binning':"700,800,900,1100,1300,1500,1800,3500",
	'binning_blind':"700,800,900,1100,1300,1500,1800",
	'type':"SIGNAL"
}
reg_1lep3_5jwin3bex1fjin0LTex1Hin0Vex = {
	...
	'binning':"700,800,900,1100,1300,1500,1900,3500",
...
reg_1lep3_5jwin3bex1fjin1Tin0Lex1Hin0Vex = {
	...
	'binning':"900,1100,1300,1650,2100,3500",
...
reg_1lep3_5jwin4bin1fjin0LTex1Hin0Vex = {
	...
	'binning':"700,900,1100,1350,1700,3500",
	'binning_blind':"700,900",
	'type':"SIGNAL"
}
...
reg_1lep3_5jwin4bin1fjin1Tin0Lex1Hin0Vex = {
	...
	'binning':"1000,1300,1600,1950,3500",
	'binning_blind':"",
	'type':"SIGNAL"
}
reg_1lep6jin1bex1fjin1Lex0Tex0Hex1Vin = {
	...
	'binning':"800,950,1100,1300,1600,2000,3500",
	'binning_blind':"800,950,1100,1300,1600,2000,3500",
	'type':"SIGNAL"
}
reg_1lep6jin1bex1fjin0Lex1Tex0Hex1Vin = {
	...
	'binning':"900,1100,1300,1600,2000,3500",
	'binning_blind':"900,1100,1300,1600,2000,3500",
	'type':"SIGNAL"
}
reg_1lep6jin1bex1fjin2LTin0Hex1Vin = {
	'name':"HTX_c1lep6jin1bex1fjin2LTin0Hex1Vin",
	'legend': "#scale[0.75]{HJ, 1b, 1fj, 2(t_{h}+t_{l}), 0h, 1V}",
	'binning':"1300,1500,1700,1950,2300,2700,3500",
	'binning_blind':"1300,1500,1700,1950,2300,2700,3500",
	'type':"SIGNAL"
}
reg_1lep6jin2bex1fjin1Lex0Tex0Hex1Vin = {
	...
	'binning':"800,1000,1200,1500,1800,3500",
	'binning_blind':"800,1000,1200,1500,1800,3500",
	'type':"SIGNAL"
}
reg_1lep6jin2bex1fjin0Lex1Tex0Hex1Vin = {
	...
	'binning':"900,1100,1300,1600,1900,2200,3500",
	'binning_blind':"900,1100,1300,1600,1900,2200,3500",
	'type':"SIGNAL"
}
...
reg_1lep6jin3bex1fjin0Lex1VTex1Hin = {
	...
	'binning':"1000,1200,1400,1700,2000,3500",
...
reg_1lep6jin3bex1fjin2VLTin1Hin = {
	...
	'binning':"1400,1600,1900,2350,3500",
	'binning_blind':"",
	'type':"SIGNAL"
}
...
reg_1lep6jin4bin1fjin0Lex1VTex1Hin = {
	...
	'binning':"1000,1200,1400,1650,2000,3500",
	'binning_blind':"",
	'type':"SIGNAL"
}
...
reg_1lep3_5jwin4bin0fjex1Lin0VTex0Hex = {
	...
	'binning':"700,900,1100,1400,1800,3500",
	'binning_blind':"700,900,1100,1400,1800,3500",
	'type':"SIGNAL"
}
...
reg_1lep3_5jwin1bex1fjin1LTin0Hex0Vex = {
	...
	'binning':"700,800,950,1100,1300,1500,1800,3500",
	'binning_blind':"700,800,950,1100,1300,1500,1800,3500",
	'type':"VALIDATION"
}
reg_1lep3_5jwin1bex1fjin1Tin0Lex0Hex1Vin = {
	...
	'binning':"800,1100,1300,1600,2000,3500",
	'binning_blind':"800,1100,1300,1600,2000,3500",
	'type':"VALIDATION"
}
...
reg_1lep3_5jwin3bin0fjex0Tex1Hin0Vex = {
	'name':"HTX_c1lep3_5jwin3bin0fjex0Tex1Hin0Vex",
	'legend': "#scale[0.75]{LJ, 3b, 0fj, 0t_{h}, 1h, 0V}",
	'binning':"700,800,900,1100,1300,1500,1800,3500",
	'binning_blind':"700,800,900,1100,1300,1500,1800,3500",
	'type':"VALIDATION"
}
reg_1lep3_5jwin3bin1fjin1VLTin0Hex = {
	'name':"HTX_c1lep3_5jwin3bin1fjin1VLTin0Hex",
...
reg_1lep6jin1bex0fjex1LTex0Hex1Vin = {
	...
	'binning':"800,1000,1100,1300,1800,3500",
	'binning_blind':"800,1000,1100,1300,1800,3500",
	'type':"VALIDATION"
}
...
reg_1lep6jin1bex1fjin0Tex0Lex1Hin1Vin = {
	...
	'binning':"900,1100,1300,1800,3500",
	'binning_blind':"900,1100,1300,1800,3500",
	'type':"VALIDATION"
}
...
reg_1lep6jin2bex0fjex1LTex0Hex1Vin = {
	...
	'binning':"800,1000,1200,1500,1900,3500",
	'binning_blind':"800,1000,1200,1500,1900,3500",
	'type':"VALIDATION"
}
...
reg_1lep6jin2bex1fjin0Tex0Lex1Hin1Vin = {
	...
	'binning':"900,1200,1500,1900,3500",
	'binning_blind':"900,1200,1500,1900,3500",
	'type':"VALIDATION"
}
