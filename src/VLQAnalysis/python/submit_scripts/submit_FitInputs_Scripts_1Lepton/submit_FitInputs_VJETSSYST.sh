...
do
	...
	producetarball=true \
        --inputDir=/data/at3/scratch2/farooque/MBJOutputs/tag-21.2.87-htztx-3-syst-VJETSSYST/ \
        --sampleDat=samples_info/samples_info.tag-21.2.87-htztx-3-syst-VJETSSYST.${campaign}.dat \
	--outputDirSuffix=FitInputs_PAIRVLQ_VJETSSYST_${campaign}_NOW \
