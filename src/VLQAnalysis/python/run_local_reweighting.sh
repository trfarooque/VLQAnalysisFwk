...
VLQAna --outputFile=test_nominal_RW_no_nominal_v2.root \
...
--REWEIGHTKINEMATICS=false --REWEIGHTNOMINALKINEMATICS=false --ONLYREWEIGHTTTBARKIN=false --NEVENTS=50000 --KINRWLIST=JETSN,MEFF
