...
def FindAndMergeFiles(proc_name, _inputDir, _outputDir, _campaigns, 
                      _systList, _doAllBRPVLQ, _dryRun, _verbose):

    sample_inputDir = _inputDir + '/ttstalt/' if(proc_name=='ttbar_alt' or proc_name=='singletop_alt') \
                      else _inputDir + '/nominal/'
    sample_outputDir = _outputDir + '/ttstalt/' if(proc_name=='ttbar_alt' or proc_name=='singletop_alt') \
                       else _outputDir + '/nominal/'
    sample_campaigns = [''] if(proc_name=='data') else _campaigns
    ...
    Samples = retrieveSamples(proc_name, '', useSyst=False, postRWPVLQ=False, allBRPVLQ=_doAllBRPVLQ)
...
def main(args):
    ...
    ##------------------------------------------------------
    parser.add_argument('--inputDir', help='Input directory containing histograms', required=True)
    parser.add_argument('--outputDir', help='Output directory where merged files will be stored', required=True)
